...
export default function ExportScreen() {
  ...
  if (!mergeResult) {
    return (
      <View style={[styles.container, { backgroundColor: colors.bg }]}>
        <Text style={[styles.title, { color: colors.text }]}>Aucun résultat</Text>
        <Pressable
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.bg }]}>
      <Text style={[styles.title, { color: colors.text }]}>Fusion terminée !</Text>
      ...
      <View style={[styles.statsGrid, { backgroundColor: colors.card, borderColor: colors.border }]}>
        ...
        <StatItem label="Surlignages" count={stats.highlights} color={colors.accent2} />
        <StatItem label="Signets" count={stats.bookmarks} color={colors.accent3} />
        <StatItem label="Étiquettes" count={stats.tags} color={colors.accent4} />
        <StatItem label="Emplacements" count={stats.locations} color={colors.accent5} />
        <StatItem label="Formulaires" count={stats.inputFields} color={colors.accent6} />
      </View>
      ...
      <View style={styles.actions}>
        ...
        >
          <Text style={styles.exportButtonText}>Partager le fichier .jwlibrary</Text>
        </Pressable>
        ...
        >
          <Text style={[styles.buttonText, { color: colors.text }]}>Nouvelle fusion</Text>
        </Pressable>
      </View>
    </View>
  );
